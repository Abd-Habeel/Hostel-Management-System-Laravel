	...
	<div class="col-md-6 bg-white msg-card pb-3">
		<div class="row head-color">
			<div class="col-2 mt-3 mb-2">
				<img src="{{asset('image/chmsc.jpg')}}" alt="logo" class="img-logo">
			</div>
			<div class="col-9 line mb-2">
				<h3 class="text-center h3 text-shadow mt-3">CHMSU HOSTEL MANAGEMENT SYSTEM</h3>
			</div>
		</div>
		<div>
			<h6 class="font-weight-bold text-danger">Welcome to Carlos Hilado Memorial State University hostel portal. For new applicatants take the steps listed below.</h6>
			<ul>
